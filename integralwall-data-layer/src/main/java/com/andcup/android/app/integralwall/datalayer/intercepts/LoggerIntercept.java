package com.andcup.android.app.integralwall.datalayer.intercepts;
...
public class LoggerIntercept implements Interceptor {
    ...
    public interface Logger {
        ...
        Logger DEFAULT = new Logger() {
            @Override public void log(String message) {
                if(IntegralWallDataLayer.getInstance().getPlatformConfigure().isDebug()){
        ...
        Logger DEBUG = new Logger() {
            @Override public void log(String message) {
                Logs.LOG2.log(message);
            }
        };
    }

    public LoggerIntercept() {
        this(Logger.DEFAULT);
    }

    public LoggerIntercept(Logger logger) {
        this.logger = logger;
    }
    ...
    public LoggerIntercept setLevel(Level level) {
